    ...
    <div class="max-w-md mx-auto bg-white p-6 rounded shadow text-black">
      ...
      <form @submit.prevent="submit">
        <div class="mb-4">
          ...
          />
          <p v-if="form.errors.current_password" class="text-red-500 text-sm">
        ...
        <div class="mb-4">
          ...
          <input
            ...
            class="w-full border rounded px-3 py-2 text-black"
          />
          <p v-if="form.errors.new_password" class="text-red-500 text-sm">
        ...
        <p v-if="flash.success" class="text-green-600 mt-2 text-sm">
          {{ flash.success }}
        </p>
      </form>
    </div>
